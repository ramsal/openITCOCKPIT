        ...
        <div class="padding-10" style="border: 1px solid #c3c3c3;">
            <div class="row">
                <div class="col-xs-2">
                    ...
                    <a href="javascript:void(0);" class="btn btn-default btn-xs listAnimateRight" data-widget-id="21"><i
                                class="fa fa-arrow-left"></i></a>
                    <a href="javascript:void(0);" class="btn btn-default btn-xs listAnimateUp" data-widget-id="21"><i
                    ...
                    <div class="form-group form-group-slider">
                        ...
                        <div class="slidecontainer">
                            <input type="range" step="5" min="0" max="300" class="slider"
                                   ng-model="statusListSettings.pagingInterval" ng-mouseup="savePagingInterval()">
                        </div>
