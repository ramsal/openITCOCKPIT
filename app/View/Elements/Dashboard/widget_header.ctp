<header class="ui-draggable-handle" role="heading">
    <div class="jarviswidget-ctrls" role="menu">
        ...
        <div class="widget-toolbar pull-left" role="menu"><a data-toggle="dropdown" class="dropdown-toggle color-box selector"
            ...
            <ul class="dropdown-menu arrow-box-up-right color-select pull-right">
                ...
                <li><span class="bg-color-greenDark" data-widget-setstyle="jarviswidget-color-greenDark" rel="tooltip"
                          data-placement="top" data-original-title="Dark Green"></span></li>
                <li><span class="bg-color-greenLight" data-widget-setstyle="jarviswidget-color-greenLight" rel="tooltip"
                ...
                <li><span class="bg-color-blueLight" data-widget-setstyle="jarviswidget-color-blueLight" rel="tooltip"
                ...
                <li><span class="bg-color-orangeDark" data-widget-setstyle="jarviswidget-color-orangeDark" rel="tooltip"
        ...
        <!--<a href="javascript:void(0);" class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="" data-placement="bottom"
        ...
        <a class="button-icon jarviswidget-delete-btn pointer" rel="tooltip" title=""
